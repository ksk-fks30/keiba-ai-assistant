...
```bash
pnpm --filter @keiba-ai-assistant/cli exec tsx src/index.ts qa-history --race-id fixture-aoba-mile-2026 --runs-dir /Users/kosuke/Development/private/keiba-ai/runs
```
